...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['innovation-manager', 'ceo', 'business-owner', 'chief-of-innovation-office'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Startup', path: '/startups', entity: 'startup', service: AccessServiceEnum.PROJECT, icon: FiTrendingUp },
